...
LINK_THE_CITY_AND_THE_STARS = "http://selenium1py.pythonanywhere.com/en-gb/catalogue/the-city-and-the-stars_95/"
...
def test_guest_should_see_login_link_on_product_page(browser):
    page = ProductPage(browser, LINK_THE_CITY_AND_THE_STARS)
    page.open()
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page = BasketPage(browser, LINK_THE_CITY_AND_THE_STARS)
